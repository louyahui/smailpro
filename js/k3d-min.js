...
window.requestAnimFrame = (function() {
    ...
    extend(K3D.K3DObject, K3D.BaseObject, {
        ...
        init: function(v, l, f) {
            ...
            for (var n = 0,
            k = this.worldcoords.length; n < k; n++) {
                this.worldcoords[n] = {
                    x: 0,
                    y: 0,
                    z: 0
            ...
            for (var n = 0,
            k = this.screencoords.length; n < k; n++) {
                this.screencoords[n] = {
                    x: 0,
                    y: 0
                }
        ...
        transformToScreen: function() {
            ...
            for (var b = 0,
            j, f, c = this.points.length; b < c; b++) {
                k = a[b].x;
                g = a[b].y;
                e = a[b].z + d;
                if (e === 0) {
